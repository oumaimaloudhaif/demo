...
public class MeetingServiceImplTest {
    ...
    public void testGetAllMeetings() {
        List<Meeting> mockedMeetings = Arrays.asList(
    ...
    public void testAddMeeting() {
        Meeting inputMeeting = new Meeting(1L,"Meeting1", LocalDateTime.of(2024, 1, 13, 12, 0), date, date);
        Meeting savedMeeting = new Meeting(1L,"Meeting1", LocalDateTime.of(2024, 1, 13, 12, 0), date, date);
        MeetingDTO expectedMeetingDTO = new MeetingDTO("Meeting1", LocalDateTime.of(2024, 1, 13, 12, 0));
   ...
   public void testUpdateMeeting() {
        Meeting inputMeeting = new Meeting(1L,"Meeting1", LocalDateTime.of(2024, 1, 13, 12, 0), date, date);
        Meeting updatedMeeting = new Meeting(1L,"Meeting1", LocalDateTime.of(2024, 1, 13, 12, 0), date, date);
        MeetingDTO expectedMeetingDTO = new MeetingDTO("Meeting1", LocalDateTime.of(2024, 1, 13, 12, 0));
