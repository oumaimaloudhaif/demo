...
public class AddressServiceImplTest {
  ...
  public void testAddAddress() {
    ...
    // Then
    assertEquals(expectedAddressDTO.postalCode(), resultAddressDTO.postalCode());
    assertEquals(expectedAddressDTO.city(), resultAddressDTO.city());
    assertEquals(expectedAddressDTO.street(), resultAddressDTO.street());
  }
